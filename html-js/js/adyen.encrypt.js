...
(function() {
    ...
    EncryptedForm.prototype = {
        ...
        /*
         *
         * Compatibility wrapper for lte IE8.
         * We create the wrapper once, rather than doing the test on each childNode.
         *
         * @param node {DOMNode}
         * @param attrName {String}
         *
         */
         hasAttribute : document.body.hasAttribute ? function(node, attrName) {
            // Native support
